...
{
   *flags |= SfMayBlock;
   PRINT("sys_freebsd6_pread ( %" FMT_REGWORD "u, %#" FMT_REGWORD
         "x, %lu, %" FMT_REGWORD "u, %" FMT_REGWORD "u )",
         ARG1, ARG2, ARG3, ARG4, ARG5);
   PRE_REG_READ5(ssize_t, "read", unsigned int, fd, char*, buf, vki_size_t,
                 count, int, pad, unsigned long, off);
...
PRE(sys_freebsd6_pwrite)
{
   Bool ok;
   *flags |= SfMayBlock;
   PRINT("sys_freebsd6_pwrite ( %" FMT_REGWORD "d, %#" FMT_REGWORD
         "x, %" FMT_REGWORD "u, %" FMT_REGWORD "u, %" FMT_REGWORD "u )",
         SARG1, ARG2, ARG3, ARG4, ARG5);
   PRE_REG_READ5(ssize_t, "write", unsigned int, fd, const char*, buf,
                 vki_size_t, count, int, pad, unsigned long, off);
...
/* caddr_t mmap(caddr_t addr, size_t len, int prot, int flags, int fd, int pad,
 * off_t pos); */
...
PRE(sys_freebsd6_mmap)
{
   ...
   PRINT("sys_mmap ( %#" FMT_REGWORD "x, %" FMT_REGWORD "u, %" FMT_REGWORD
         "u, %" FMT_REGWORD "u, %" FMT_REGWORD "u, pad%" FMT_REGWORD
         "u, 0x%" FMT_REGWORD "x)",
         ARG1, (UWord)ARG2, ARG3, ARG4, ARG5, ARG6, ARG7);
   PRE_REG_READ7(long, "mmap", char*, addr, unsigned long, len, int, prot, int,
                 flags, int, fd, int, pad, unsigned long, pos);
...
{
   PRINT("sys_freebsd6_lseek ( %" FMT_REGWORD "u, 0x%" FMT_REGWORD
         "x, %#" FMT_REGWORD "x, %" FMT_REGWORD "u )",
         ARG1, ARG2, ARG3, ARG4);
   PRE_REG_READ4(long, "lseek", unsigned int, fd, int, pad, unsigned long,
                 offset, unsigned int, whence);
}
#endif
...
PRE(sys_freebsd6_truncate)
{
   *flags |= SfMayBlock;
   PRINT("sys_truncate ( %#" FMT_REGWORD "x(%s), %" FMT_REGWORD "u )", ARG1,
         (char*)ARG1, ARG3);
   PRE_REG_READ3(long, "truncate", const char*, path, int, pad, unsigned int,
                 length);
...
PRE(sys_freebsd6_ftruncate)
{
   *flags |= SfMayBlock;
   ...
   PRE_REG_READ3(long, "ftruncate", unsigned int, fd, int, pad, unsigned int,
                 length);
}
#endif
